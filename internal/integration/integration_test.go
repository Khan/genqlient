...
func TestSimpleQuery(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := simpleQuery[string](ctx, client)
...
func TestMutation(t *testing.T) {
	...
	resp, _, err := createUser[string](ctx, postClient, NewUser{Name: "Jack"})
	require.NoError(t, err)
	assert.Equal(t, "5", resp.CreateUser.Id)
	assert.Equal(t, "Jack", resp.CreateUser.Name)

	_, _, err = createUser[string](ctx, getClient, NewUser{Name: "Jill"})
...
func TestServerError(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := failingQuery[string](ctx, client)
...
func TestVariables(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithVariables[string](ctx, client, "2")
		require.NoError(t, err)
		...
		resp, _, err = queryWithVariables[string](ctx, client, "374892379482379")
		require.NoError(t, err)
...
func TestExtensions(t *testing.T) {
	...
	for _, client := range clients {
		_, extensions, err := simpleQueryExt[string](ctx, client)
		require.NoError(t, err)
...
func TestOmitempty(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithOmitempty[string](ctx, client, "2")
		require.NoError(t, err)
		...
		resp, _, err = queryWithOmitempty[string](ctx, client, "")
		require.NoError(t, err)
...
func TestCustomMarshal(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithCustomMarshal[string](ctx, client,
...
func TestCustomMarshalSlice(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithCustomMarshalSlice[string](ctx, client,
...
func TestCustomMarshalOptional(t *testing.T) {
	...
	for _, client := range clients {
		...
		resp, _, err := queryWithCustomMarshalOptional[string](ctx, client, &date, nil)
		require.NoError(t, err)
		...
		id := "2"
		resp, _, err = queryWithCustomMarshalOptional[string](ctx, client, nil, &id)
		require.NoError(t, err)
		assert.Len(t, resp.UserSearch, 1)
		user = resp.UserSearch[0]
...
func TestInterfaceNoFragments(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithInterfaceNoFragments[string](ctx, client, "1")
		require.NoError(t, err)
		...
		resp, _, err = queryWithInterfaceNoFragments[string](ctx, client, "3")
		require.NoError(t, err)
		...
		resp, _, err = queryWithInterfaceNoFragments[string](ctx, client, "4757233945723")
		require.NoError(t, err)
...
func TestInterfaceListField(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithInterfaceListField[string](ctx, client,
...
func TestInterfaceListPointerField(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithInterfaceListPointerField[string](ctx, client,
			[]string{"1", "3", "12847394823"})
		require.NoError(t, err)
...
func TestFragments(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithFragments[string](ctx, client, []string{"1", "3", "12847394823"})
		require.NoError(t, err)
...
func TestNamedFragments(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithNamedFragments[string](ctx, client, []string{"1", "3", "12847394823"})
		require.NoError(t, err)
...
func TestFlatten(t *testing.T) {
	...
	for _, client := range clients {
		resp, _, err := queryWithFlatten[string](ctx, client, []string{"1", "3", "12847394823"})
		require.NoError(t, err)
